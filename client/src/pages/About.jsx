...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-dark-950">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-square bg-gradient-to-br from-primary-600 to-accent-600 rounded-3xl p-8 flex items-center justify-center">
      ...
      {/* Values Section */}
      <section className="py-24 bg-gradient-to-r from-dark-900/30 to-dark-800/30">
        <div className="container">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
              ...
              return (
                ...
                >
                  <Card className="p-8 h-full">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary-600 to-accent-600 rounded-lg flex items-center justify-center mb-6">
          ...
          <div className="max-w-4xl mx-auto">
            {timeline.map((item, index) => (
              ...
              >
                ...
                <div className="w-4 h-4 bg-primary-500 rounded-full border-4 border-dark-950 relative z-10">
                ...
                {index < timeline.length - 1 && (
                  <div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-24 bg-gradient-to-b from-primary-500 to-accent-500 mt-16" />
                )}
              </motion.div>
            ))}
          </div>
                ...
                <Card className="text-center p-6 h-full">
                  <div className="relative mb-6">
                    <img
                      src={member.image}
                      alt={member.name}
                      className="w-24 h-24 rounded-full mx-auto object-cover border-4 border-primary-500"
                    />
                  ...
                  <span className="inline-block px-3 py-1 bg-accent-900/30 text-accent-300 rounded-full text-xs">
                    {member.speciality}
                  </span>
                </Card>
              </motion.div>
      ...
      <section className="py-24">
        <div className="container">
          <motion.div
            ...
            className="text-center"
          >
            <Card className="p-12 bg-gradient-to-r from-primary-900/20 to-accent-900/20">
              <h2 className="text-4xl font-bold gradient-text mb-6">
                Join Our Mission
              </h2>
